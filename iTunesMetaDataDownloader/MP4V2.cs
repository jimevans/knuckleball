...
namespace iTunesMetaDataDownloader
{
    class MP4V2
    {
        ...
        [DllImport("libMP4V2.dll", CharSet = CharSet.Ansi, ExactSpelling = true, SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        internal static extern IntPtr MP4Modify(string filename, int flags);

        [DllImport("libMP4V2.dll", CharSet = CharSet.Ansi, ExactSpelling = true, SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        internal static extern bool MP4Optimize(string filename, string newname);

        [DllImport("libMP4V2.dll", CharSet = CharSet.Ansi, ExactSpelling = true, SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void MP4Close(IntPtr file);

        [DllImport("libMP4V2.dll", CharSet = CharSet.Ansi, ExactSpelling = true, SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        internal static extern IntPtr MP4ItmfGetItemsByMeaning(IntPtr file, string meaning, string name);
        ...
        [DllImport("libMP4V2.dll", CharSet = CharSet.Ansi, ExactSpelling = true, SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void MP4TagsSetEncodedBy(IntPtr tags, string name);
